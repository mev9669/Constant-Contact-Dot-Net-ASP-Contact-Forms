<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddContactSmallForm.aspx.cs" ValidateRequest="false"
    Inherits="AddContactSmallForm" MasterPageFile="~/Master.master" Title="Constant Contact - Add new Contact [Simplified Form]" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MasterContentPlaceHolder" runat="Server">
    <div style="margin-left: 30px; margin-top: 10px">
        <asp:Label runat="server" ID="lbl1" Text="Add new Contact - Simplified Form" Font-Names="Calibri"
            Font-Size="20pt">
        </asp:Label>
    </div>
